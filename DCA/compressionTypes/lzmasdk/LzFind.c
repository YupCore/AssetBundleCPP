...
void LzFindPrepare()
{
    ...
    _Bool HW_MMX;
    _Bool HW_x64;
    _Bool HW_ABM;      // Advanced Bit Manipulation
    _Bool HW_RDRAND;
    _Bool HW_BMI1;
    _Bool HW_BMI2;
    _Bool HW_ADX;
    _Bool HW_PREFETCHWT1;
    ...
    //  SIMD: 512-bit
    _Bool HW_AVX512F;    //  AVX512 Foundation
    _Bool HW_AVX512CD;   //  AVX512 Conflict Detection
    _Bool HW_AVX512PF;   //  AVX512 Prefetch
    _Bool HW_AVX512ER;   //  AVX512 Exponential + Reciprocal
    _Bool HW_AVX512VL;   //  AVX512 Vector Length Extensions
    _Bool HW_AVX512BW;   //  AVX512 Byte + Word
    _Bool HW_AVX512DQ;   //  AVX512 Doubleword + Quadword
    _Bool HW_AVX512IFMA; //  AVX512 Integer 52-bit Fused Multiply-Add
    _Bool HW_AVX512VBMI; //  AVX512 Vector Byte Manipulation Instructions
